...
<?php
if(mysql_real_escape_string(urlencode($_GET['logout']))=='true'){
  echo '<br><br><div class="alert alert-success" id="alert" style="margin-left:auto; margin-right:auto;">
          <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a><strong>Logout</strong>, avvenuto con successo.
  ...
  if (!session_destroy()) {
    echo '<br><br><div class="alert alert-danger" id="alert" style="margin-left:auto; margin-right:auto;">
            <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a><strong>Attenzione</strong>, Il Logout <strong>NON</strong> &egrave avvenuto con successo.
          </div><style>@media screen and (min-width: 100px) and (max-width: 420px){
            #alert{
              width:80%;
              }
    ...
    mysql_close();
    header('location:close_session.php?logout=true');
  }
}
?>
</body>
