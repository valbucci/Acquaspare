        ...
        <div class="alert alert-success">
          <center>
            <h3 style="margin-left:auto; margin-right:auto;">
              <i class="fa fa-thumbs-o-up"></i> Il Pagamento è stato Effettuato con Successo!
            </h3>
          </center>
        </div>
      </div>
        ...
        <div class="alert alert-info">
          <center>
            <h4 style="margin-top:15px;">
              <i class="fa fa-info-circle" aria-hidden="true"></i> Riceverai a breve una <strong>E-Mail</strong> di Conferma
              <?php
                if(isset($_SESSION['id'])){
                  echo 'all\'Indirizzo: <strong>'.$row['email'].'</strong>';
                }
              ?>
            </h4>
          </center>
